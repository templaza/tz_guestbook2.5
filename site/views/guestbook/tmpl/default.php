...
-------------------------------------------------------------------------*/
    ...
    $document -> addScript('components/com_tz_guestbook/js/jquery.masonry.min.js');
    $document -> addScript('components/com_tz_guestbook/js/jquery.infinitescroll.min.js');
...
//-----------------------------------------------------------------------------------------//
         ...
         jQuery('#warp-input-sub').click(function(){// khi clich vao id la warp-input-sub thi bat dau chay jeax
...
<?php
    ...
    if(isset($phantrang_Default)){ // kiem tra xem bien co ton tai hay k neu ton tai thi goi ham phan trang default cua jooomla
  ?>
<div class="container">
...
<div id="tz_append">
    ...
    if($this->conajx == 1){ // neu nguoi dung chon =1 thj phan trang theo buttom
        ?>
    <a href="#tz_append"><?php echo JText::_("COM_TZ_GUESTBOOK_ADD_ITEMS"); ?></a>
        <p><?php echo JText::_("COM_TZ_GUESTBOOK_NO_ITEMS"); ?></p>
    <?php
    }
     ?>
        ...
        $container.infinitescroll({ // bat dau tu dau lay du lieu
                ...
                errorCallback: function(){
                      ...
                      <?php if($this->conajx == 2):?>
                        jQuery('#tz_append').removeAttr('style').html('<a class="tzNomore"><?php echo JText::_('COM_TZ_GUESTBOOK_NO_ITEMS');?></a>');
                      <?php endif;?>
