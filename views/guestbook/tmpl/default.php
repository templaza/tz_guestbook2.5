...
<form action="index.php?option=com_tz_guestbook" method="post"  name="adminForm" id="adminForm">
    ...
    <table class="adminlist">
        <thead>
            ...
            <th width="3%">
                <?php echo JHtml::_('grid.sort',JText::_('COM_TZ_GUESTBOOK_GLOBAL_PUBLICH_EMAIL'),'publich', $listDirn, $listOrder) ?>
            </th>
            <th width="5%">
            ...
            if(isset($this->display) && !empty($this->display)){
                ...
                ?>
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            <a href="<?php echo JRoute::_('index.php?option=com_tz_guestbook&task=g_edit&id='.$num->cid);?>">
                                <?php  echo $num->ctitle; ?>
                            </a>
                        </td>
                        <td class="center">
